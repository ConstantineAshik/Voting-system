...
<div class="container-fluid">
    ...
    <span class="rem_btn" style="position: absolute; top: 10px; right: 10px;">
        <button class="btn btn-rounded btn-sm btn-outline-danger del_candidated" data-id="<?php echo $candidate['id'] ?>">
            <i class="fa fa-trash"></i>
        </button>
    </span>
    <div class="item" data-id="<?php echo $candidate['id'] ?>" style="text-align: center; padding: 20px;">
        <div style="display: flex; justify-content: center; align-items: center;">
            <img src="assets/img/<?php echo $candidate['image_path'] ?>" alt="" style="max-width: 100px; border-radius: 50%;">
        </div>
        <br>
        <div class="text-center">
